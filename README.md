...
The goal of PracticeRPackage is to make regular expressions more
...
You can install the development version of PracticeRPackage from
...
That’s exactly what `PracticeRPackage::str_split_one()` does.

``` r
library(PracticeRPackage)
