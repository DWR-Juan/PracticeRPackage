...
The goal of PracticeRPackage is to make regular expressions more exciting!
...
You can install the development version of PracticeRPackage from [GitHub](https://github.com/) with:
